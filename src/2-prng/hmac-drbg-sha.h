...
#define xHMAC_DRBG_HMAC_SHA1(q) xHMAC_DRBG(HMAC_SHA1, q)
#define xHMAC_DRBG_HMAC_SHA256(q) xHMAC_DRBG(HMAC_SHA256, q)
#define xHMAC_DRBG_HMAC_SHA384(q) xHMAC_DRBG(HMAC_SHA384, q)
