...
#define rot     glue(keccak_word_t,__rot) // unused.

#define theta   glue(keccak_word_t,__theta) // unused.
#define rho     glue(keccak_word_t,__rho)
#define pi      glue(keccak_word_t,__pi)
#define chi     glue(keccak_word_t,__chi) // unused.
...
static inline void theta64(keccak_state_t A)
{
    uint64x2_t C[4], D, T;
    register int y;
...
static inline void chi64(keccak_state_t A)
{
