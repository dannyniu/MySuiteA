...
// ----
// ${ [2].aux } was previously the salt length. Now it's set to
// the digest length of the hash function, and changed through
// context control functions.
typedef CryptoParam_t PKCS1_Padding_Oracles_Param_t[2];
