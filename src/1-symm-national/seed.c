...
static const alignas(256) uint8_t table_s0[256] = {
...
static const alignas(256) uint8_t table_s1[256] = {
...
static inline uint8_t S0(uint8_t x)
{
    return sbox(x, table_s0);
}

static inline uint8_t S1(uint8_t x)
{
    return sbox(x, table_s1);
}
